(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))l(s);new MutationObserver(s=>{for(const e of s)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const e={};return s.integrity&&(e.integrity=s.integrity),s.referrerPolicy&&(e.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?e.credentials="include":s.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function l(s){if(s.ep)return;s.ep=!0;const e=t(s);fetch(s.href,e)}})();document.querySelector("#app").innerHTML=`
  <div>
    <header class="header">
            ...
            <ul class="services__list grid grid--2">
              ...
              <li class="services__item">
                <article class="service-card service-card--accent-bg">
                  <div class="service-card__body ">
                    <h3 class="service-card__title">
                      <span class="puddle-bg puddle-bg--light">Pay-perp-click</span>
                      <span class="puddle-bg puddle-bg--light">advertizing</span>
                    </h3>
                    <a href="" class="service-card__link">
                      <span class="service-card__link-icon-wrapper">
                          <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="services__banner banner">
              <div class="banner__inner">
                <div class="banner__body">
                  ...
                  <button class="banner__button button">Get your free proposal</button>
                </div>
                <img 
                  src="./images/services/banner-bg.svg" 
                  alt="" 
                  class="banner__image hidden-mobile"
                  width="494" height="394"
                >
              </div>
            </div>
          </div>
          ...
          <div class="studies">
            <ul class="studies__list">
              ...
              <li class="studies__item">
                <div class="studies__description">
                  <p>
                    For a B2B software company, we developed an SEO 
                    strategy that resulted in a first page ranking for 
                ...
                <details class="process__accordion" open>
                  ...
                  <div class="process__accordion-body">
                    <p>
                      ...
                      goals and objectives, target audience, and current marketing efforts.
                ...
                <article class="team-card">
                  ...
                  <div class="team-card__body">
                    <p>
                      ...
                      Proficient in creating and scheduling content, 
      ...
      <div class="footer__inner">
        ...
        <div class="footer__body">
          ...
          <form class="footer__subscribe-form subscribe-form">
            ...
            <div class="subscribe-form__field field field--big-height field--dark-bg">
              <label for="subscribe-email" class="field__label visually-hidden">
                Email
              </label>
              <input 
                type="email"
            ...
            <button 
              class="sunscribe-form__button button button--accent"
              type="submit"
              >
              Subscribe to news
            </button>
        ...
        <div class="footer__extra">
          <p class="footer__copyright">
            © <time datetime="2025">2025</time> Positivus. All Rights Reserved.
          </p>
